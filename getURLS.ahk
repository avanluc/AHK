...
^+!u::
	file := FileOpen("C:\Users\lavanzini\Downloads\SavedURLS.txt","w")
	WinGetClass, sClass, A
	pURL := GetActiveBrowserURL()
	file.WriteLine(pURL)
	Loop
	{
		BlockInput, on
		Send, {Ctrl Down}{Tab}{Ctrl Up}   ;cycle to next tab using keyboard shortcuts
		BlockInput, off
